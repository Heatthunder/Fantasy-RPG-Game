...
sword_drawn = 0
sword_sprite = pygame.Surface((1,1))
...
while True:
    ...
    sally.set_colorkey ((63,81,181))
    sally_box = sally.get_rect()
    sally_box.move_ip(97, 90)
    ...
    weapon1.set_colorkey ((63,81,181))
    weapon1B = enemyA_box.move(50, 30)
    screen.blit(weapon1, weapon1B)

    if sword_drawn > 0:
            screen.blit(sword_sprite, weapon2B)
            sword_drawn -= 1
            if enemyA_box.colliderect(weapon2B):
                enemyA_pos[0] = random.choice((100, 200, 300, 400, 500, 600))
                enemyA_pos[1] = random.choice((100, 200, 300, 400, 500, 600))
